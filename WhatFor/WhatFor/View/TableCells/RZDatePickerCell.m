...
#pragma mark - RZDatePickerCell Implementation
@implementation RZDatePickerCell
...
- (void)doneTapped {
    ...
    [[self textLabel] setText:[self formattedDate]];
}
...
- (BOOL)resignFirstResponder {
	UITableView *tableView = (UITableView *)[self rzFirstSuperviewOfClassType:[UITableView class]];
